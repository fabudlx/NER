...
class EmbeddingModel():
    ...
    def __init__(self, path = r'C:\Users\fkarl\Desktop\Science Stuff\pretrained Model\wiki.en.vec',lower=False, binary = False, ):
        print('loading w2v model... this could take a while')
        self.w2v_model = KeyedVectors.load_word2vec_format(path, binary=binary)
        self.lower = lower
        print('word2vec model loaded')

    def get_embedding_improved(self, list_of_words ):
        return_list = []
        not_known_words =[]
