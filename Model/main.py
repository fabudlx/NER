...
# NER.test_model('bi-lstm','bi-lstm_connl03_fasttext_deu','dev','connl03','fasttext_deu',data_format='IBO2',language='deu',pos_of_tag=4)
...
# NER.train_model('bi-lstm_char', 'bi-lstm_char_connl03_fasttext_deu',1024, 8,'connl03','fasttext_deu')
# NER.train_model('bi-lstm_char', 'bi-lstm_char_sharedTask_fasttext_deu',1024, 7,'sharedTask','fasttext_deu')

# NER.train_model('bi-lstm', 'bi-lstm_connl03_fasttext_deu',512, 15,'connl03','fasttext_deu')
...
# NER.test_model('bi-lstm', 'bi-lstm_connl03_fasttext_deu', 'dev','connl03', 'fasttext_deu', data_format='IBO2', language='deu', pos_of_tag=4)
# NER.test_model('bi-lstm', 'bi-lstm_connl03_fasttext_deu', 'test','connl03', 'fasttext_deu', data_format='IBO2', language='deu', pos_of_tag=4)
...
# NER.test_model('bi-lstm_char', 'bi-lstm_char_sharedTask_fasttext_deu', 'dev','connl03', 'fasttext_deu', data_format='IBO2', language='deu', pos_of_tag=4,save_name = 'bi-lstm_char_sharedTask_fasttext_deu')
...
# NER.test_model('bi-lstm_crf_char', 'bi-lstm_crf_char_sharedTask_fasttext_deu', 'dev','connl03', 'fasttext_deu', data_format='IBO2', language='deu', pos_of_tag=4,save_name = 'bi-lstm_crf_char_sharedTask_fasttext_deu')
...
# NER.test_model('bi-lstm_char', 'bi-lstm_char_sharedTask_fasttext_deu', 'test','connl03', 'fasttext_deu', data_format='IBO2', language='deu', pos_of_tag=4)
# NER.test_model('bi-lstm_crf_char', 'bi-lstm_crf_char_connl03_fasttext_deu', 'test','connl03', 'fasttext_deu', data_format='IBO2', language='deu', pos_of_tag=4)
# NER.test_model('bi-lstm_crf_char', 'bi-lstm_crf_char_sharedTask_fasttext_deu', 'test','connl03', 'fasttext_deu', data_format='IBO2', language='deu', pos_of_tag=4)
